# Generated by Django 5.1.4 on 2025-01-22 23:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cantidad', models.IntegerField()),
                ('tipo_recepcion', models.CharField(choices=[('vendido', 'Vendido'), ('devuelto', 'Devuelto'), ('recepcion', 'Recepcion')], max_length=9)),
                ...
                ('id_empleado_recibio', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='recibio_recepciones', to=settings.AUTH_USER_MODEL)),
                ('idbodega', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='inventario.bodega')),
                ('idproducto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='inventario.producto')),
            ],
        ),
